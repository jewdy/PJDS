    ...
    <div className="profile-container">
      ...
      <main className="main-content">
        <section className="about-me" data-aos="fade-up">
          ...
          <p>
            A computer science major with a knack for writing. I've spent over three years as a campus journalist, and now I specialize in creating content that connects with people. <br /><br />
            
            My experience in SEO-optimized writing has equipped me with the skills that deliver results aligning with clients’ goals, from conducting topic and keyword research to writing articles/blogs that drive engagement. <br /><br />
            
            Outside of writing, I'm a nature enjoyer who loves hiking and camping with friends. I share my home with a cat named Roxie and a dog named Gus. My dream is to be able to travel and immerse myself in different cultures around the world.
          </p>
